...
***** HTTP requests
An endpoint will be provided by the platform for the function that was deployed.
...
***** Data arrival in a storage or data broker system
...
No open endpoints for functions. docker containers can't be easily discovered.
****** ETL
