...
\label{sec:org386fb9e}
\paragraph{Statelessness}
\label{sec:org9f87e3a}
...
\label{sec:orgc91c758}
\paragraph{Faas + Microservices}
\label{sec:orgf81736f}
...
\label{sec:orga518cb0}
\begin{enumerate}
\item Controller:
\label{sec:org8be4121}
...
\label{sec:org4b53a90}

\paragraph{Logs}
\label{sec:orge240731}
...
\subsection{Tools}
\label{sec:org85e2c63}
\subsubsection{Container Orchestration}
\label{sec:orgaa72a1a}
...
\section{Conclusion}
\label{sec:org7e14d52}
\section{References}
\label{sec:org64c24a4}
\begin{enumerate}
