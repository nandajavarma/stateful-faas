...
\label{sec:org28e20d2}
\paragraph{Statelessness}
\label{sec:orgd776635}
...
\label{sec:orgd11c05b}
\subsection{Problem statement}
\label{sec:org423e27f}
...
\label{sec:org96c3d1a}
\begin{enumerate}
\item Controller:
\label{sec:orgaccde96}
...
\subsection{Tools}
\label{sec:orgc3a6c14}
\subsubsection{Container Orchestration}
\label{sec:org19a2dee}
...
\subparagraph{Docker image:}
\label{sec:orge4b63b1}
Like in any virtual machine environment, images can be thought of somewhat a
...
\label{sec:org034a577}
If Docker image is a digital photograph, a docker container is like a printout
...
\subparagraph{Orchestration tools:}
\label{sec:org903a063}
Docker by default ship a couple of orchestration tools that are specific to
...
\label{sec:org6f35313}
It is very useful to understand the concept of Namespaces in Kubernetes though.
...
asynchronously by replacing/function/ with \emph{async-function} when accessing the
...
\label{sec:org11a74b5}
\subsubsection{Prometheus}
\label{sec:org5bed277}
\subsubsection{Jauguer}
\label{sec:orgfd3a843}
\subsubsection{Minio}
\label{sec:orgd3a8601}
\subsection{Architecture}
\label{sec:org1da24d4}
\section{Evaluation}
\label{sec:orgd19732c}
\section{Future work}
\label{sec:orgb221302}
\section{Conclusion}
\label{sec:org1496eab}
